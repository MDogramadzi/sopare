...
DynamicReadOnlyCharacteristic.prototype.onReadRequest = function(offset, callback) {
  ...
  var data = new Buffer('Marko Value - Read');
...
WriteOnlyCharacteristic.prototype.onWriteRequest = function(data, offset, withoutResponse, callback) {
  console.log('WriteOnlyCharacteristic write request: ' + data.toString('utf8') + ' ' + offset + ' ' + withoutResponse);
